...
import com.example.common_ground_android.ui.fragments.navigation.profile.ProfileFragmentDirections
...
class ProfileFragment : Fragment() {
    ...
    private fun updateProfileInfo(profile: com.example.common_ground_android.network.model.domain.profile.Profile) {
        ...
        binding.statisticsCard.visibility = if (isEmptyProfile) View.GONE else View.VISIBLE
    }
