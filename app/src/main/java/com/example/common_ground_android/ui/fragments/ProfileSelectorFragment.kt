...
import com.example.common_ground_android.ui.fragments.navigation.profile.ProfileSelectorFragmentDirections
...
class ProfileSelectorFragment : Fragment() {
    ...
    private fun selectProfile(profile: com.example.common_ground_android.network.model.domain.profile.Profile) {
        viewLifecycleOwner.lifecycleScope.launch {
